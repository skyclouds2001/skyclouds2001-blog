...
Node.js 是运行在服务端的 JavaScript 环境，允许在浏览器之外的环境运行 JavaScript 代码文件

### 重要知识点

事件、流、文件、多线程、fs模块、path模块、http模块、axios库、express库、数据库
...
包管理工具目前主流有三种，分别是 npm、yarn、pnpm，其中npm由于与node的深度绑定，是前端开发中无法避免接触的内容
...
TypeScript是JavaScript的一个超集，增加了类型系统的语法，在实际开发中使用非常广泛
